import { HitAreaCallback, InteractiveObject } from "../types/input";
 ...
 */
function CreateInteractiveObject(gameObject: GameObject, hitArea: any, hitAreaCallback: HitAreaCallback): InteractiveObject {
    return {
...
export default CreateInteractiveObject;
