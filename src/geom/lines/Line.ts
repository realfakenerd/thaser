...
export default class Line {
  ...
  static BresenhamPoints(
    ...
    stepRate?: number,
    results?: Phaser.Types.Math.Vector2Like[]
   ...
   */
  static GetEasedPoints<O extends Phaser.Geom.Point[]>(
    line: Phaser.Geom.Line,
   ...
   */
  static GetNearestPoint<O extends Phaser.Geom.Point>(
    line: Phaser.Geom.Line,
   ...
   */
  static GetPoints<O extends Phaser.Geom.Point[]>(
    line: Phaser.Geom.Line,
    quantity: number,
    stepRate?: number,
    out?: O
   ...
   */
  static GetShortestDistance<O extends Phaser.Geom.Point>(
    line: Phaser.Geom.Line,
    point: Phaser.Geom.Point | object
  ): O;
   ...
   * @param angle The angle of rotation in radians.
   */
  static RotateAroundXY<O extends Phaser.Geom.Line>(
    line: O,
    x: number,
    y: number,
    angle: number
   ...
   */
  static SetToAngle<O extends Phaser.Geom.Line>(
    line: O,
    x: number,
    y: number,
    angle: number,
